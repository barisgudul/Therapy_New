...
export const getAdaptiveTherapistReplyPrompt = (
    ...
    if (contextLevel === 'minimal') {
        ...
        return `Senin rolün: ${selectedPersonalityDescription}. Adın ${therapistName}. Kullanıcının adı ${userName || 'yok'}. Sana "${userMessage}" dedi. Sıcak bir karşılama yap (1-2 cümle).`.trim();
