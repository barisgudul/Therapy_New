...
Deno.serve(async (req) => {
    ...
    try {
        ...
        console.log(
            `[DECISION_LOGGER] Yeni karar kaydediliyor: ${decision_category}`,
        );
        ...
        console.log(
            `[DECISION_LOGGER] ✅ Karar kaydedildi: ${savedDecision.id}`,
        );
...
async function cleanupOldDecisions(
    ...
    try {
        ...
        console.log(
            `[DECISION_LOGGER] ${oldIds.length} eski karar kaydı temizlendi`,
        );
    } catch (error) {
