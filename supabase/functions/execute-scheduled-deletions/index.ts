// supabase/functions/execute-scheduled-deletions/index.ts
...
// Handler'ı bir değişken olarak tanımla
...
// Test dosyasının import edebilmesi için handler'ı export et
