...
async function analyzeRecentDecisions(
    ...
    console.log(
        `[META-COGNITION] Son ${lookbackHours} saatteki kararlar analiz ediliyor...`,
    );
    ...
    if (!decisions || decisions.length === 0) {
        console.log("[META-COGNITION] Analiz edilecek karar bulunamadı");
        return [];
    }
    ...
    console.log(`[META-COGNITION] ${analyses.length} karar analiz edildi`);
    return analyses;
}
...
async function analyzePatternEffectiveness(
    ...
    console.log(`[META-COGNITION] Kalıp etkinliği analiz ediliyor...`);
    ...
    console.log(`[META-COGNITION] ${insights.length} kalıp analiz edildi`);
    return insights;
}
...
async function generateStrategyRefinements(
    ...
    console.log(`[META-COGNITION] Strateji iyileştirmeleri üretiliyor...`);
...
Deno.serve(async (req) => {
    ...
    try {
        ...
        console.log(`[META-COGNITION] ${trigger_type} analizi başlatılıyor...`);
        ...
        console.log(`[META-COGNITION] ✅ ${trigger_type} analizi tamamlandı`);
