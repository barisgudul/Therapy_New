// supabase/functions/_shared/vault.service.ts
...
export async function getUserVault(
  ...
  try {
    ...
    console.error("⛔️ Vault getirme hatası (admin):", (error as Error).message);
    throw error;
  }
}
...
export async function updateUserVault(
  ...
  try {
    ...
    console.error("⛔️ Vault update hatası (admin):", (error as Error).message);
    throw error;
  }
}
