...
export default function BeforeFeelingScreen() {
    ...
    const handleSave = async () => {
        ...
        // Mood'u session için kaydet
        await AsyncStorage.setItem('currentSessionMood', currentMoodLabel);
        
        opacity.value = withTiming(0, { duration: 400 });
        setTimeout(() => {
            // Seçilen session türüne yönlendir
        ...
        <View style={styles.container}>
            ...
            <Animated.View style={[styles.contentContainer, { opacity }]}>
                <View style={styles.header}>
                    <Text style={styles.title}>Seans Öncesi Ruh Hali</Text>
