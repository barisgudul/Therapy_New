// app/(guest)/__tests__/step2.test.tsx
...
describe('Step2', () => {
  ...
  it('soru metni gösterilmelidir', () => {
    ...
    expect(screen.getByText('onboarding_step2.question')).toBeTruthy();
  });
  ...
  it('next fonksiyonu çağrıldığında setAnswer ve router.push çalışmalıdır', () => {
    ...
    expect(mockSetAnswer).toHaveBeenCalledWith(2, 'onboarding_step2.question', 'Test answer');
    expect(mockPush).toHaveBeenCalledWith('/(guest)/step3');
  });
