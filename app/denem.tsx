  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <Modal visible={inputVisible} transparent animationType="fade" onRequestClose={() => setInputVisible(false)}>
        <BlurView intensity={35} tint="dark" style={[StyleSheet.absoluteFill, { backgroundColor: 'rgba(0,0,0,0.3)' }]} />
      ...
      <Modal visible={feedbackVisible} transparent animationType="fade" onRequestClose={closeFeedback}>
        ...
        <View style={styles.modalContainer}>
          <View style={[styles.modalContent, { backgroundColor: 'rgba(255,255,255,0.98)' }]}>
            ...
            <View style={styles.modalDivider} />
            <Text style={[styles.modalText, { lineHeight: 24 }]}>{aiMessage || 'AI analiz ediyor...'}</Text>
          </View>
        </View>
      </Modal>
